<x-filament::page>
    ...
    <div class="kb-page">
        ...
        @else
            ...
            @else
                <div class="kb-card" style="overflow-x:auto;">
                    <div class="kb-cols">
                        @foreach ($stages as $stage)
                            @php
                                    ...
                                    @forelse ($tasksByStage[$stage->id] as $task)
                                        <div class="kb-task">
                                            ...
                                            <div class="kb-row" style="margin-top:8px;gap:6px;">
                                                ...
                                                @if($prevStage)
                                                    <button wire:click="moveTaskToStage({{ $task->id }}, {{ $prevStage->id }})" class="kb-btn" style="padding:6px 10px;">&#8592; {{ $prevStage->name }}</button>
                                                @endif
                                                @if($nextStage)
                                                    <button wire:click="moveTaskToStage({{ $task->id }}, {{ $nextStage->id }})" class="kb-btn" style="padding:6px 10px;">{{ $nextStage->name }} &#8594;</button>
                                                @endif
                                            </div>
                                        </div>
                                    @empty
