...
<article class="van-card">
    ...
    <div class="van-card-body">
        ...
        <div class="vr:mt-auto"><span class="van-small">Desde</span> <strong class="van-price">{{ number_format($van->startingRate() / 100, 2, ',', ' ') }} €</strong> {{ $van->startingPricingUnit() === 'two_days' ? '/ 2 dias' : '/ hora' }}<br><span class="van-small">IVA incluído @if($van->startingPricingUnit() !== 'two_days') · mínimo {{ $van->minimum_hours }} h @endif</span></div>
