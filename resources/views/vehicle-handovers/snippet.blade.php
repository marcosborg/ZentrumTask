<style>
    .handover-doc { max-width: 1080px; margin: 0 auto; background: #fff; border-radius: 20px; padding: 28px; box-shadow: 0 20px 50px rgba(15, 23, 42, 0.08); font-family: Arial, sans-serif; color: #16233b; }
    ...
    .handover-doc__signatures { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 20px; margin-top: 28px; }
    .handover-doc__signature { width: 100%; min-height: 140px; border: 1px dashed #cbd5e1; border-radius: 14px; background: #fff; }
    .handover-doc h2 { font-size: 18px; margin: 0 0 12px; }
    .handover-doc section + section { margin-top: 24px; }
</style>
