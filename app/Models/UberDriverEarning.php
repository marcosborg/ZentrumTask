...
class UberDriverEarning extends Model
{
    /** @use HasFactory<\Database\Factories\UberDriverEarningFactory> */
    use HasFactory;

    protected $fillable = [
        'uber_sync_run_id',
        'driver_id',
        'uber_driver_identifier',
        'uber_driver_uuid',
        'uber_individual_uuid',
        'uber_driver_name',
        'uber_driver_email',
    ...
    {
        return $this->belongsTo(UberSyncRun::class, 'uber_sync_run_id');
    }
